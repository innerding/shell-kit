            ...
            fontFamily: 'system-ui,-apple-system,sans-serif',
                ...
                boxShadow: '0 12px 44px rgba(0,0,0,0.34)',
                                        ...
                                        : svgHtml
                                            ...
                                            : _jsx("span", { style: { flexShrink: 0, width: 48, height: 48, borderRadius: '50%', background: 'rgba(20,34,62,0.08)' } }), _jsx("div", { style: { flex: 1, minWidth: 0 }, children: _jsxs("div", { style: { display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 8, font: '700 16px/1.3 system-ui,sans-serif' }, children: [_jsx("span", { children: title }), arrival && flagSvg ? (
                                        ...
                                        ? _jsx("p", { style: { margin: 0, font: '400 13.5px/1.5 system-ui,sans-serif', color: '#33415c' }, children: description })
                                        : _jsx("p", { style: { margin: 0, font: 'italic 400 12.5px/1.5 system-ui,sans-serif', color: '#9aa6bd' }, children: labels.noDescription }), link && (_jsx("a", { href: link, target: "_blank", rel: "noopener noreferrer", onClick: (e) => e.stopPropagation(), style: { display: 'inline-block', marginTop: 8, font: '600 12.5px/1 system-ui,sans-serif', color: NAVY, textDecoration: 'none' }, children: labels.learnMore })), members && members.length > 0 && (_jsxs("div", { style: { marginTop: 10 }, children: [_jsx("div", { style: { font: '700 10px/1 system-ui,sans-serif', letterSpacing: '0.06em', color: '#9aa6bd', marginBottom: 6 }, children: labels.targets(members.length) }), _jsx("div", { style: { display: 'flex', flexWrap: 'wrap', gap: 4 }, children: members.map((m, i) => (_jsx("span", { style: { font: '500 11.5px/1.1 system-ui,sans-serif', color: '#33415c', background: 'rgba(20,34,62,0.06)', borderRadius: 6, padding: '3px 7px' }, children: m }, i))) })] })), hint && (_jsxs("div", { style: { marginTop: 12, font: '600 12px/1.3 system-ui,sans-serif', color: NAVY, display: 'flex', alignItems: 'center', gap: 6 }, children: [_jsx("span", { "aria-hidden": true, style: { fontSize: 14 }, children: "\u2295" }), hint] }))] })] })] }) }) }));
}
