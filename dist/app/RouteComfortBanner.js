...
export default function RouteComfortBanner({ breach, message = DEFAULT_MESSAGE }) {
    if (!breach)
        return null;
    return (_jsxs("div", { role: "alert", style: {
        ...
        }, children: [_jsx("span", { style: { fontSize: 18, flexShrink: 0, lineHeight: 1 }, "aria-hidden": true, children: "\u26A0" }), _jsx("span", { children: message })] }));
}
