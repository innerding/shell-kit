 ...
 */
export declare function renderClusterPois(map: L.Map, layer: L.LayerGroup, members: ClusterMember[], ghostByCluster: Map<string, ClusterGhost>, onMemberClick?: (member: ClusterMember) => void, routeNumOf?: (id: string) => number, numBadgeHtml?: (n: number, size: number, stackIndex?: number) => string, onMemberLongPress?: (member: ClusterMember) => void, onGhostClick?: (clusterName: string) => void): void;
