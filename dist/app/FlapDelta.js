...
export default function FlapDelta({ minutes, dockHeight, tint, blink, onCommit }) {
    ...
    return (_jsxs("div", { onClick: onCommit ? (e) => { e.stopPropagation(); onCommit(); } : undefined, role: onCommit ? 'button' : undefined, "aria-label": onCommit ? 'Umweg wählen' : undefined, style: {
