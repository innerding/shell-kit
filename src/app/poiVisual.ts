...
export const POI_SIZE = { degraded: 1.0, normal: 1.2, route: 1.6 } as const;
...
export function poiBreaches(load: number, comfort: number): boolean {
  return load > comfort;
}
...
function hektikOf(load: number, comfort: number): number {
